...
\begin{cvskills}
	\cvskill{Programming}{Knowledgeable in C++, Java, Python, MATLAB, Javascript}
	\cvskill{O.S.}{Linux, Windows}
	\cvskill{Other}{\LaTeX, Git, ROS, TLA+}
\end{cvskills}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Volunteer
...
%\cvsection{Hobbies}
%\begin{cvskills}
%	\cvskill{Practicing Sports}{Tennis, Climbing, Judo, Boxe, Sailing}
